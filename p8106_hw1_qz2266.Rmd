...
- This model is quite straightforward and easy to fit.The estimates are BLUE.The mean-square test error (MSE) for this model is `r lm_mse`.
...
```
From the summary of this partial least squares model we can find the number of components is 12. The test error is `r pls_mse`.
